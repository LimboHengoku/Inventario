...
public class ProveedorController implements Serializable {
	...
	public ResponseEntity<?> consultarProveedor(@RequestBody 
	...
	public ResponseEntity<?> registrarProveedor(@RequestBody
	...
	public ResponseEntity<?> actualizarProveedor(@RequestBody
			RegistrarProveedorRequest req){
